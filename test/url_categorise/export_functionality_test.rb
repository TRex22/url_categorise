...
class UrlCategorise::ExportFunctionalityTest < Minitest::Test
  ...
  def test_export_csv_data_with_default_path
    ...
    assert(lines.any? do |line|
      line.include?("example.com") && line.include?("test_category") && line.include?("dataset")
    end)
    assert(lines.any? do |line|
      line.include?("malicious.com") && line.include?("malware") && line.include?("blocklist")
    end)
