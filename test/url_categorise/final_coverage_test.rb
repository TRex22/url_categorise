...
class UrlCategoriseFinalCoverageTest < Minitest::Test
  ...
  def test_empty_and_nil_response_handling
    ...
    assert hosts_data1.empty? || hosts_data1 == [[]], "Expected empty hosts data for empty_test, got: #{hosts_data1.inspect}"
    assert hosts_data2.empty? || hosts_data2 == [[]], "Expected empty hosts data for nil_test, got: #{hosts_data2.inspect}"
  end
