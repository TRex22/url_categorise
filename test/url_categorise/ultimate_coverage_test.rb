...
class UrlCategoriseUltimateCoverageTest < Minitest::Test
  ...
  def test_edge_cases(client)
    ...
    result = client.send(:build_host_data, ["invalid-url", "another-invalid"])
    assert_equal [], result
